...
% The responsibilities and qualifications required for this role are already very similar to the role I am in currently. I have experience building a Ruby on Rails platform to be highly resilient and available for critical infrastructures, like hospitals and clinics. Due to the nature of developing a platform, my current role has also afforded me many opportunities to learn about the ecosystem around the platform to gain more insight into how I can improve it. I think my added experience with microservice architecture, REST API design, the OpenAPI Specification, container orchestration, system observability, and more would make for a quick and easy transition.
